...
<html>
    ...
    <sql:setDataSource driver="com.mysql.jdbc.Driver" url="jdbc:mysql://localhost:3306/login_accounts?characterEncoding=utf8" user="root" password="Meoluoi910@"></sql:setDataSource>
        <sql:query var="mcq">
