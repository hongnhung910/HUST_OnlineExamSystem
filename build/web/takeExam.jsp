        ...
        <form action="evaluate" method="POST">
            <center><h1>${selectedexam} Examination</h1></center> 
                ...
                <ol id="${questioncnt}">
                    ...
                    <h3><span>Q<c:out value="${questioncnt}"></c:out>.&nbsp;</span><c:out value="${mcqexam.ques_title}"></c:out></h3>
                    <input type="radio" name="${mcqexam.quesID}" value="${mcqexam.ans_choice1}" required="">&nbsp;<c:out value="${mcqexam.ans_choice1}"></c:out><br>
                    <input type="radio" name="${mcqexam.quesID}"value="${mcqexam.ans_choice2}" required="">&nbsp;<c:out value="${mcqexam.ans_choice2}"></c:out><br>
                    <input type="radio" name="${mcqexam.quesID}" value="${mcqexam.ans_choice3}" required="">&nbsp;<c:out value="${mcqexam.ans_choice3}"></c:out><br>
                    <input type="radio" name="${mcqexam.quesID}" value="${mcqexam.ans_choice4}" required="">&nbsp;<c:out value="${mcqexam.ans_choice4}"></c:out>
