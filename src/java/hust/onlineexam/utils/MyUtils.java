...
public class MyUtils {
    ...
    public static void storeLoginedStudent(HttpSession session, Student loginedUser) {
        // On the JSP can access via ${loginedUser}
        session.setAttribute("loginedUser", loginedUser);
    }

    public static void storeLoginedTeacher(HttpSession session, Teacher loginedUser) {
        // On the JSP can access via ${loginedUser}
        session.setAttribute("loginedUser", loginedUser);
    }
    ...
    public static Teacher getLoginedTeacher(HttpSession session) {
        Teacher loginedUser = (Teacher) session.getAttribute("loginedUser");
        return loginedUser;
    }
